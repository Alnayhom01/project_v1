...
class ForgotPassword extends StatelessWidget {
  ...
  Widget _phoneStep(ForgotPasswordController controller) {
    return Column(
  ...
  Widget _otpStep(ForgotPasswordController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        const SizedBox(height: 55),
  ...
  Widget _passwordStep(ForgotPasswordController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        const SizedBox(height: 55),
